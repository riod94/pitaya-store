...
async function seed() {
  try {
    ...
    await db.insert(paymentMethods).values([
      // Generic payment method toggles
      {
        name: 'Bank Transfer',
        type: 'bank_transfer',
        code: 'bank_transfer',
        description: 'Manual bank transfer to configured bank accounts',
        instruction: 'Transfer to one of our bank accounts',
        fees: '0',
        feeType: 'fixed',
        processingTime: '1-3 hours after transfer',
        isActive: true
      },
      {
        name: 'E-Wallet',
        type: 'e_wallet',
        code: 'ewallet',
        description: 'Manual transfer to configured e-wallet accounts',
        instruction: 'Transfer to one of our e-wallet accounts',
        fees: '0',
        feeType: 'fixed',
        processingTime: '1-3 hours after payment',
        isActive: true
      },
      {
        name: 'QRIS',
        type: 'qris',
        code: 'qris',
        description: 'Scan QRIS code untuk pembayaran',
        instruction: 'Scan QR code menggunakan aplikasi e-wallet atau mobile banking Anda',
        fees: '0',
        feeType: 'fixed',
        processingTime: '1-3 hours after transfer',
        isActive: true
