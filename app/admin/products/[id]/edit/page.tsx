  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const productData = {
        ...
        images: images.length > 0 ? images.map(img => URL.createObjectURL(img)) : product.images,
        dimensions: {
      ...
      if (variantEnabled && variants.length > 0) {
        // First, delete existing variants (in a real app, you might want to be more selective)
