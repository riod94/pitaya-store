...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Currently, we ship throughout Indonesia. For international orders, please contact our customer service team at info@pitaya.com to discuss shipping options and rates.",
  },
  {
    ...
    <section className="py-16 bg-gray-50">
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center mb-12">
          ...
          <p className="text-gray-600">Find answers to common questions about our products, ordering, and shipping.</p>
        </div>
