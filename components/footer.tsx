          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                ...
                <span className="text-gray-400">Deli Serdang, Indonesia</span>
              </li>
              <li className="flex items-start">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                <span className="text-gray-400">+62 822 7756 3627</span>
              </li>
              <li className="flex items-start">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                <span className="text-gray-400">halo.pitaya@gmail.com</span>
              </li>
            </ul>
          </div>
        </div>
